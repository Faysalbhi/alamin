...
@php
    $seo = App\Models\SEO::where('slug', 'about-us')->first();
@endphp
@section('header')
        ...
        <div class="container">
            <div class="bradecrumb-main" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{$page->title ?? null}}</li>
                </ol>
            </div>
            <div class="row">
